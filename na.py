...
# MASTER QUESTION BANK KAJFA (Fakkii fi Sagalee fakkeenyaaf qopheeffame qaba)
if "SECRET_MASTER_QUESTION_BANKS" not in str_app.session_state:
    str_app.session_state.SECRET_MASTER_QUESTION_BANKS = {
        "Kutaa 1": {
            "afaan_oromoo": [
                {
                    "question": "Qubee jalqabaa qubee Afaan Oromoo maali?", 
            ...
            "math": [
                {
                    "question": "1 + 1 hammami?", 
                    "options": ["A) 1", "B) 2", "C) 3", "D) 4"], 
                    "answer": "B", 
                    "type": "mcq", 
                    "image": "https://upload.wikimedia.org/wikipedia/commons/9/9a/Pencil_And_Paper.jpg", 
                    "audio": None
                },
        ...
        "Kutaa 6": {
            "afaan_oromoo": [
                {
                    "question": "Jecha 'Goota' jedhuuf hiika tokko filadhu:", 
                    "options": ["A) Sodaa", "B) Jajjabaa/Namicha hojii guddaa hojjete", "C) Dadhabaa", "D) Dhukkubsataa"], 
                    "answer": "B", 
                    "type": "mcq", 
                    "image": "https://upload.wikimedia.org/wikipedia/commons/e/ec/Hero_symbol_from_the_Projet_Volta.png", 
                    "audio": None
                },
